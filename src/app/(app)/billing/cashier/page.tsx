...
export default function CashierPage() {
  return (
    <div>
      <h1 className="text-2xl font-semibold text-gray-900 mb-6">Cashier — Collect Payment</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            ...
            <input type="search" placeholder="Search patient…" className="border border-gray-300 rounded-lg px-3 py-1.5 text-xs w-48 focus:outline-none" />
          </div>
